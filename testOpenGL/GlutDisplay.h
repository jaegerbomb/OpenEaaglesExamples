...
// Class: GlutDisplay
//------------------------------------------------------------------------------
#ifndef __Eaagles_TESTOPENGL_GlutDisplay_H__
#define __Eaagles_TESTOPENGL_GlutDisplay_H__
...
//
//------------------------------------------------------------------------------
class GlutDisplay : public BasicGL2_0::Display {
   DECLARE_SUBCLASS(GlutDisplay, BasicGL2_0::Display)
