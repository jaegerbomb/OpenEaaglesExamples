...
//
//------------------------------------------------------------------------------
#ifndef __EAAGLES_TESTOPENGL_TESTTWO_H__
#define __EAAGLES_TESTOPENGL_TESTTWO_H__
...
class TestTwo : public BasicGL2_0::Graphic
{
    DECLARE_SUBCLASS(TestTwo,BasicGL2_0::Graphic)
